...
$$
P\{1 \leq \min(X, Y) \leq 2\} = (1 - e^{-4}) - (1 - e^{-2}) = e^{-2}(1 - e^{-2})
$$
...
**解：** 对于连续型随机变量，  $P\{X_1 = \min(X_1, X_2, X_3)\} = P\{X_1 \leq X_2, X_1 \leq X_3\}$

$$
= \int_0^{+\infty} P\{X_2 \geq x_1, X_3 \geq x_1\} f_{X_1}(x_1) dx_1
$$
